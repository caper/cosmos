$(function() 
	...
	window.z_rotate=0;
		...
		function show_back(side)
		{
			...
			switch(side)
				{
					case 'right':	y=-90;x=0; $('.back').removeClass('transform_back'); break;
					case 'top':	y=0;x=-90; $('.back').addClass('transform_back'); break;
					case 'left':	y=90;x=0; $('.back').removeClass('transform_back'); break;
					case 'bottom':	y=0;x=90; $('.back').addClass('transform_back'); break;
